...
export default function FeatureCard({
  ...
  return (
    <div className="relative rounded-xl border border-border-subtle bg-surface p-6 transition-all duration-300 hover:-translate-y-0.5 hover:border-[var(--vault-glow)] hover:shadow-[0_8px_30px_-12px_var(--vault-glow)] sm:p-8">
